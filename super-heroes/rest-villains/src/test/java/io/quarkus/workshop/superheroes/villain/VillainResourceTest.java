...
class VillainResourceTest {
    ...
    void shouldGetRandomVillain() {
        given()
            ...
            .then().statusCode(Response.Status.OK.getStatusCode()).contentType(APPLICATION_JSON);
    }
    ...
    void shouldGetInitialItems() {
        List<Villain> villainList = get("/api/villains")
            .then()
        ...
        assertEquals(NB_VILLAINS, villainList.size());
    }
